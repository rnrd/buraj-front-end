...
import {getKisaDevelopmanliKurpDataFromApi} from "../redux/actions/Actions";
import alertify from 'alertifyjs';
import 'alertifyjs/build/css/alertify.css';
import KisaDevelopmanliKurpChart from "./KisaDevelopmanliKurpChart";


function KisaDevelopmanliKurp(props) {
...
const kisaDevelopmanliKurpDispatch=useDispatch();

const getResult=(data)=>{
  kisaDevelopmanliKurpDispatch(getKisaDevelopmanliKurpDataFromApi(data));  
}


const result=useSelector(state=>state.kisaDevelopmanliKurpReducer,shallowEqual);
//const stateWatch=useSelector(state=>state.stateWatcherReducer,shallowEqual);
      ...
      <Container className="basitkurp-container-2">
        <Form>
          ...
          <Row>
            <Col sm="8" className=" input-alert offset-4">
              <FormText color="muted">
                Parabol boyları için 11 metre ve üzeri bir değer giriniz.
              </FormText>
            </Col>
          </Row>
        </Form>
      </Container>
      <KisaDevelopmanliKurpChart postData={postData}/>
    </div>
  );
}

export default KisaDevelopmanliKurp;
