...
import {getBasitKurpChartDataFromApi} from "../redux/actions/Actions";
...
function BasitKurpChart(props) {
    ...
    const basitKurpChartDispatch=useDispatch();

    const getResult=(data)=>{

        //console.log(data);
        basitKurpChartDispatch(getBasitKurpChartDataFromApi(data))
    }

    const result=useSelector(state=>state.basitKurpChartReducer,shallowEqual);
    console.log(result);
