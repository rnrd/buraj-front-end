...
import {getKisaDevelopmanliKurpChartDataFromApi} from "../redux/actions/Actions";
...
function KisaDevelopmanliKurpChart(props) {

      const postData = {
        R : props.postData.R,
        Dever : props.postData.Dever,
        Lgp : props.postData.Lgp,
        Lk : props.postData.Lk,
        Lcp : props.postData.Lcp,
    ...
    const KisaDevelopmanliKurpChartDispatch=useDispatch();

    const getResult=(data)=>{

        KisaDevelopmanliKurpChartDispatch(getKisaDevelopmanliKurpChartDataFromApi(data))
    }

    const result=useSelector(state=>state.kisaDevelopmanliKurpChartReducer,shallowEqual);

    var kurpBoyu=props.postData.Lgp+props.postData.Lk+props.postData.Lcp;
...
export default KisaDevelopmanliKurpChart;
